...
app.post("https://casatrastullo.onrender.com/newuser", urlencodedParser, function(req, res) {
...
app.post("https://casatrastullo.onrender.com/user", urlencodedParser, function(req, res) {
  const userEmail = req.body["email"];
  const userPassword = req.body["password"];
...
app.post("https://casatrastullo.onrender.com/availability", urlencodedParser, function(req, res) {
...
app.post("https://casatrastullo.onrender.com/booking", urlencodedParser, function(req, res) {
...
app.post("https://casatrastullo.onrender.com/email", urlencodedParser, function(req, res) {
...
app.get("https://casatrastullo.onrender.com/allreservations", urlencodedParser, function(req, res) {
...
app.get("https://casatrastullo.onrender.com/allusers", urlencodedParser, function(req, res) {
  const result = users();
  console.log(result);
  res.send(result);
  res.end();
...
app.post("https://casatrastullo.onrender.com/updateR", urlencodedParser, function(req, res) {
